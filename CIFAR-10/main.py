...
# Instance de classe pour dataset
data = dataset(nb_imgs=args.nb_imgs)

# Instance de classe pour lenet
net = LeNet()

# Définition d'un dictionnaire avec les paramètres du réseau
params = {
...
# Chargement des paramètres dans le réseau
net.load_params(params)

positive = 0
# Itération sur l'ensemble de la base de données
